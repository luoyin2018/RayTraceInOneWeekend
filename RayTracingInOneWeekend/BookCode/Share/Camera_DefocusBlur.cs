...
{
    public class Camera_DefocusBlur
    {
         private static readonly double DegreeToRadius = Math.PI / 180;
            ...
            public Camera_DefocusBlur(Vector3 lookfrom, Vector3 lookat, Vector3 up,  float vfov, float aspect, float aperture, float focusDist) 
            {
            ...
            {
                Vector3 rd = lensRadius * Randomizer.RandomInUnitDisk();
